...
Multi-owned/Shareable among accounts SBTs should be issued to a contract account that implements a multi-signature functionality, this can be achieved via the [ERC1155 Token Receiver interface]( https://eips.ethereum.org/EIPS/eip-1155#erc-1155-token-receiver), as defined in eip-1555.
