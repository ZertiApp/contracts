...
interface ISBTDS {
    ...
    /**
     * @dev Mints(creates) a token and Transfers it from `_from` to `_to`.
     *
     * Requirements:
     *
     ...
     * -`_data` should comply with the SBTDS Metadata Standard.
     *
     * Emits a {TokenTransfer} event.
     *
     * Returns a boolean value indicating whether the operation succeeded.
     */
    function mint (string memory _data, address _to) external returns(bool);

    /**
     * @dev Mints(creates) a token and Transfers it from `_from` to every address at `_to[]`.
     *
     ...
     * Returns a boolean value indicating whether the operation succeeded.
     */
    function mintBatch(string memory _data, address[] memory _to) external returns (bool);
